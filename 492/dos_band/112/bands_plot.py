...
bndplot(datafile,fermi,symmetryfile,ax,shift_fermi=-4.4244,\
color='black', linestyle='solid', name_k_points=['G','Z'], title='Band structure of 1*1*2 carbon chain')

plt.yticks(np.arange(-20, 9, step=5))
plt.show()
