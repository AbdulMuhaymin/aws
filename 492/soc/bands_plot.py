...
datafile='6_c.bands_pp.dat.gnu'
fermi = -4.4313
symmetryfile='6_c.bands_pp.out'
...
bndplot(datafile,fermi,symmetryfile,ax,shift_fermi=-4.4313,\
color='black', linestyle='solid', name_k_points=['G','Z'], title='Band structure of 1*1*1 C chain (with SOC)')

plt.yticks(np.arange(-20, 30, step=5))
